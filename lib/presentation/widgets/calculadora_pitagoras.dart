...
class CalculadoraPitagoras extends StatefulWidget {
  ...
  @override
  State<CalculadoraPitagoras> createState() => _CalculadoraPitagorasState();
}

class _CalculadoraPitagorasState extends State<CalculadoraPitagoras> {
        ...
        SegmentedButton<String>(
          ...
          onSelectionChanged: (Set<String> newSelection) {
            setState(() {
              ...
              // Limpiar el campo que ahora está deshabilitado
